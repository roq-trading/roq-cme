...
#include <cme/sbe/ilink/AvgPxInd.h>
#include <cme/sbe/ilink/ClearingAcctType.h>
#include <cme/sbe/ilink/CmtaGiveUpCD.h>
#include <cme/sbe/ilink/CustOrdHandlInst.h>
#include <cme/sbe/ilink/CustOrderCapacity.h>
#include <cme/sbe/ilink/ListUpdAct.h>
#include <cme/sbe/ilink/SLEDS.h>
#include <cme/sbe/ilink/SMPI.h>
...
struct PartyDetailsDefinitionRequest final {
  ...
  ::cme::sbe::ilink::ListUpdAct::Value list_update_action = {};
  uint32_t seq_num = {};
  std::string_view memo;
  std::string_view avg_px_group_id;
  uint64_t self_match_prevention_id = {};
  ::cme::sbe::ilink::CmtaGiveUpCD::Value cmta_giveup_cd = {};
  ::cme::sbe::ilink::CustOrderCapacity::Value cust_order_capacity = {};
  ::cme::sbe::ilink::ClearingAcctType::Value clearing_account_type = {};
  ::cme::sbe::ilink::SMPI::Value self_match_prevention_instruction = {};
  ::cme::sbe::ilink::AvgPxInd::Value avg_px_indicator = {};
  ::cme::sbe::ilink::SLEDS::Value clearing_trade_price_type = {};
  ::cme::sbe::ilink::CustOrdHandlInst::Value cust_order_handling_inst = {};
  uint64_t executor = {};
  uint64_t idm_short_code = {};
  // NoPartyDetails
  struct PartyDetails final {
    std::string_view party_detail_id;
    ::cme::sbe::ilink::PartyDetailRole::Value party_detail_role;
  };
...
template <>
struct fmt::formatter<roq::cme::protocol::ilink::PartyDetailsDefinitionRequest> {
  constexpr auto parse(format_parse_context &context) { return std::begin(context); }
  auto format(roq::cme::protocol::ilink::PartyDetailsDefinitionRequest const &value, format_context &context) const {
