...
template <>
struct fmt::formatter<roq::cme::protocol::ilink::OrderCancelRequest> {
  constexpr auto parse(format_parse_context &context) { return std::begin(context); }
  auto format(roq::cme::protocol::ilink::OrderCancelRequest const &value, format_context &context) const {
