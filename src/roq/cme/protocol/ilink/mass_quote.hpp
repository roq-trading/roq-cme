...
template <>
struct fmt::formatter<roq::cme::protocol::ilink::MassQuote::QuoteEntry> {
  constexpr auto parse(format_parse_context &context) { return std::begin(context); }
  auto format(roq::cme::protocol::ilink::MassQuote::QuoteEntry const &value, format_context &context) const {
...
template <>
struct fmt::formatter<roq::cme::protocol::ilink::MassQuote> {
  constexpr auto parse(format_parse_context &context) { return std::begin(context); }
  auto format(roq::cme::protocol::ilink::MassQuote const &value, format_context &context) const {
    using namespace std::literals;
    return fmt::format_to(
        context.out(),
        R"({{)"
