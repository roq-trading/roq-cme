...
template <>
struct fmt::formatter<roq::cme::protocol::ilink::QuoteCancel::QuoteEntry> {
  constexpr auto parse(format_parse_context &context) { return std::begin(context); }
  auto format(roq::cme::protocol::ilink::QuoteCancel::QuoteEntry const &value, format_context &context) const {
...
template <>
struct fmt::formatter<roq::cme::protocol::ilink::QuoteCancel::QuoteSet> {
  constexpr auto parse(format_parse_context &context) { return std::begin(context); }
  auto format(roq::cme::protocol::ilink::QuoteCancel::QuoteSet const &value, format_context &context) const {
    using namespace std::literals;
    return fmt::format_to(
        context.out(),
        R"({{)"
...
template <>
struct fmt::formatter<roq::cme::protocol::ilink::QuoteCancel> {
  constexpr auto parse(format_parse_context &context) { return std::begin(context); }
  auto format(roq::cme::protocol::ilink::QuoteCancel const &value, format_context &context) const {
    using namespace std::literals;
    return fmt::format_to(
        context.out(),
        R"({{)"
