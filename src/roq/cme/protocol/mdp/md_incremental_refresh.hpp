...
struct fmt::formatter<::cme::sbe::mdp::MDIncrementalRefreshBook46::NoMDEntries> {
  ...
  auto format(value_type const &value, format_context &context) const {
    ...
    return fmt::format_to(
        ...
        value.mDUpdateAction(),
        value.mDEntryType(),
        roq::cme::protocol::mdp::get_int(value.tradeableSize(), value.tradeableSizeNullValue()));
  }
};
...
struct fmt::formatter<::cme::sbe::mdp::MDIncrementalRefreshBook46::NoOrderIDEntries> {
  ...
  auto format(value_type const &value, format_context &context) const {
    ...
    return fmt::format_to(
        ...
        roq::cme::protocol::mdp::get_int(value.mDDisplayQty(), value.mDDisplayQtyNullValue()),
        roq::cme::protocol::mdp::get_int(value.referenceID(), value.referenceIDNullValue()),
...
struct fmt::formatter<::cme::sbe::mdp::MDIncrementalRefreshBook46> {
  ...
  auto format(value_type &value, format_context &context) const {
    ...
    return fmt::format_to(
        ...
        "no_order_id_entries=[{}]"
        "}}"sv,
        roq::cme::protocol::mdp::Group{value.noOrderIDEntries()});
  }
};
...
struct fmt::formatter<::cme::sbe::mdp::MDIncrementalRefreshOrderBook47::NoMDEntries> {
  ...
  auto format(value_type const &value, format_context &context) const {
    ...
    return fmt::format_to(
        ...
        R"(md_entry_type={})"
        R"(}})"sv,
        roq::cme::protocol::mdp::get_int(value.orderID(), value.orderIDNullValue()),
        roq::cme::protocol::mdp::get_int(value.mDOrderPriority(), value.mDOrderPriorityNullValue()),
        const_cast<value_type &>(value).mDEntryPx(),
        roq::cme::protocol::mdp::get_int(value.mDDisplayQty(), value.mDDisplayQtyNullValue()),
        value.securityID(),
...
struct fmt::formatter<::cme::sbe::mdp::MDIncrementalRefreshTradeSummary48::NoMDEntries> {
  ...
  auto format(value_type const &value, format_context &context) const {
    ...
    return fmt::format_to(
        ...
        value.mDUpdateAction(),
        value.mDEntryType(),
        roq::cme::protocol::mdp::get_int(value.mDTradeEntryID(), value.mDTradeEntryIDNullValue()));
  }
};
