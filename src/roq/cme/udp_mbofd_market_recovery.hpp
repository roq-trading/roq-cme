...
struct UDPMBOFDMarketRecovery final : public io::net::udp::Receiver::Handler, public mdp::Parser::Handler {
  struct Handler {
  ...
  UDPMBOFDMarketRecovery(Handler &, io::Context &, uint16_t stream_id, Shared &, Channel &);

  UDPMBOFDMarketRecovery(UDPMBOFDMarketRecovery const &) = delete;
  UDPMBOFDMarketRecovery(UDPMBOFDMarketRecovery &&) = delete;
