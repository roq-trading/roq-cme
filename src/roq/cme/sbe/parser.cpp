...
bool Parser::dispatch(Handler &handler, std::span<std::byte const> const &buffer, TraceInfo const &trace_info) {
  ...
  if (Frame::parse(buffer, [&](auto &frame) {
        ...
        while (!std::empty(message)) {
          ...
          log::debug("template={}"sv, template_id);
          auto length =
          ...
          switch (template_id) {
            ...
            case cme_mdp::MDInstrumentDefinitionFuture54::SBE_TEMPLATE_ID: {
              cme_mdp::MDInstrumentDefinitionFuture54 value{std::data(tmp), std::size(tmp)};
              create_trace_and_dispatch(handler, trace_info, value, frame);
              break;
            }
            case cme_mdp::MDInstrumentDefinitionOption55::SBE_TEMPLATE_ID: {
              cme_mdp::MDInstrumentDefinitionOption55 value{std::data(tmp), std::size(tmp)};
              create_trace_and_dispatch(handler, trace_info, value, frame);
              break;
            }
            case cme_mdp::MDInstrumentDefinitionSpread56::SBE_TEMPLATE_ID: {
              cme_mdp::MDInstrumentDefinitionSpread56 value{std::data(tmp), std::size(tmp)};
              create_trace_and_dispatch(handler, trace_info, value, frame);
              break;
            }
            case cme_mdp::MDInstrumentDefinitionFixedIncome57::SBE_TEMPLATE_ID: {
              cme_mdp::MDInstrumentDefinitionFixedIncome57 value{std::data(tmp), std::size(tmp)};
              create_trace_and_dispatch(handler, trace_info, value, frame);
              break;
            }
            case cme_mdp::MDInstrumentDefinitionRepo58::SBE_TEMPLATE_ID: {
              cme_mdp::MDInstrumentDefinitionRepo58 value{std::data(tmp), std::size(tmp)};
              create_trace_and_dispatch(handler, trace_info, value, frame);
              break;
            }
            case cme_mdp::MDInstrumentDefinitionFX63::SBE_TEMPLATE_ID: {
              cme_mdp::MDInstrumentDefinitionFX63 value{std::data(tmp), std::size(tmp)};
              create_trace_and_dispatch(handler, trace_info, value, frame);
              break;
            }
              // - SnapshotFullRefresh
            case cme_mdp::SnapshotFullRefresh52::SBE_TEMPLATE_ID: {
              cme_mdp::SnapshotFullRefresh52 value{std::data(tmp), std::size(tmp)};
              create_trace_and_dispatch(handler, trace_info, value, frame);
              break;
            }
            case cme_mdp::SnapshotFullRefreshOrderBook53::SBE_TEMPLATE_ID: {
              cme_mdp::SnapshotFullRefreshOrderBook53 value{std::data(tmp), std::size(tmp)};
              create_trace_and_dispatch(handler, trace_info, value, frame);
              break;
            }
            case cme_mdp::SnapshotFullRefreshLongQty69::SBE_TEMPLATE_ID: {
              cme_mdp::SnapshotFullRefreshLongQty69 value{std::data(tmp), std::size(tmp)};
              create_trace_and_dispatch(handler, trace_info, value, frame);
              break;
            }
              // - MDIncrementalRefresh
            case cme_mdp::MDIncrementalRefreshVolume37::SBE_TEMPLATE_ID: {
              cme_mdp::MDIncrementalRefreshVolume37 value{std::data(tmp), std::size(tmp)};
              create_trace_and_dispatch(handler, trace_info, value, frame);
              break;
            }
            ...
            case cme_mdp::MDIncrementalRefreshOrderBook47::SBE_TEMPLATE_ID: {
              cme_mdp::MDIncrementalRefreshOrderBook47 value{std::data(tmp), std::size(tmp)};
              create_trace_and_dispatch(handler, trace_info, value, frame);
              break;
            }
            case cme_mdp::MDIncrementalRefreshTradeSummary48::SBE_TEMPLATE_ID: {
              cme_mdp::MDIncrementalRefreshTradeSummary48 value{std::data(tmp), std::size(tmp)};
              create_trace_and_dispatch(handler, trace_info, value, frame);
              break;
            }
            case cme_mdp::MDIncrementalRefreshDailyStatistics49::SBE_TEMPLATE_ID: {
              cme_mdp::MDIncrementalRefreshDailyStatistics49 value{std::data(tmp), std::size(tmp)};
              create_trace_and_dispatch(handler, trace_info, value, frame);
              break;
            }
            case cme_mdp::MDIncrementalRefreshLimitsBanding50::SBE_TEMPLATE_ID: {
              cme_mdp::MDIncrementalRefreshLimitsBanding50 value{std::data(tmp), std::size(tmp)};
              create_trace_and_dispatch(handler, trace_info, value, frame);
              break;
            }
            case cme_mdp::MDIncrementalRefreshSessionStatistics51::SBE_TEMPLATE_ID: {
              cme_mdp::MDIncrementalRefreshSessionStatistics51 value{std::data(tmp), std::size(tmp)};
              create_trace_and_dispatch(handler, trace_info, value, frame);
              break;
            }
            case cme_mdp::MDIncrementalRefreshBookLongQty64::SBE_TEMPLATE_ID: {
              cme_mdp::MDIncrementalRefreshBookLongQty64 value{std::data(tmp), std::size(tmp)};
              create_trace_and_dispatch(handler, trace_info, value, frame);
              break;
            }
            case cme_mdp::MDIncrementalRefreshTradeSummaryLongQty65::SBE_TEMPLATE_ID: {
              cme_mdp::MDIncrementalRefreshTradeSummaryLongQty65 value{std::data(tmp), std::size(tmp)};
              create_trace_and_dispatch(handler, trace_info, value, frame);
              break;
            }
            case cme_mdp::MDIncrementalRefreshVolumeLongQty66::SBE_TEMPLATE_ID: {
              cme_mdp::MDIncrementalRefreshVolumeLongQty66 value{std::data(tmp), std::size(tmp)};
              create_trace_and_dispatch(handler, trace_info, value, frame);
              break;
            }
            case cme_mdp::MDIncrementalRefreshSessionStatisticsLongQty67::SBE_TEMPLATE_ID: {
              cme_mdp::MDIncrementalRefreshSessionStatisticsLongQty67 value{std::data(tmp), std::size(tmp)};
              create_trace_and_dispatch(handler, trace_info, value, frame);
              break;
            }
            default: {
