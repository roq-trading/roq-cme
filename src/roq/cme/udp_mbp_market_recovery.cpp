...
UDPMBPMarketRecovery::UDPMBPMarketRecovery(
    ...
    : handler_{handler}, channel_name_{channel.get_channel_name(NAME)}, stream_id_{stream_id},
      ...
      profile_{
          ...
          .snapshot_full_refresh = create_metrics(shared.settings, name_, "snapshot_full_refresh"sv),
          .snapshot_full_refresh_long_qty = create_metrics(shared.settings, name_, "snapshot_full_refresh_long_qty"sv),
      },
...
void UDPMBPMarketRecovery::operator()(metrics::Writer &writer) {
  writer  //
      ...
      .write(profile_.snapshot_full_refresh, metrics::Type::PROFILE)
      .write(profile_.snapshot_full_refresh_long_qty, metrics::Type::PROFILE);
}
