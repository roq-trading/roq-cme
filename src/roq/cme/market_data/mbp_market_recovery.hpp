...
struct MBPMarketRecovery final : public protocol::mdp::Parser::Handler {
  MBPMarketRecovery(Shared &, Channel &, uint16_t stream_id, protocol::mdp::Config const &, uint16_t channel_id, Priority);
