...
struct MBOFDMarketRecovery final : public protocol::mdp::Parser::Handler {
  MBOFDMarketRecovery(Shared &, Channel &, uint16_t stream_id, protocol::mdp::Config const &, uint16_t channel_id, Priority);
