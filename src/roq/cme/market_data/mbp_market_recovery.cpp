...
namespace {
auto const CONNECTION_TYPE = protocol::mdp::ConnectionType::MBP_MARKET_RECOVERY;
...
void emplace_back(T const &item, auto &security, auto &bids, auto &asks) {
  switch (item.mDEntryType()) {
    using enum ::cme::sbe::mdp::MDEntryType::Value;
    case Bid:
...
void MBPMarketRecovery::operator()(protocol::mdp::Frame const &) {
}

void MBPMarketRecovery::operator()(Trace<::cme::sbe::mdp::AdminHeartbeat12> const &event, protocol::mdp::Frame const &frame) {
...
void MBPMarketRecovery::operator()(Trace<::cme::sbe::mdp::ChannelReset4> const &event, protocol::mdp::Frame const &frame) {
  using value_type = std::remove_cvref_t<decltype(event)>::value_type;
  auto &value = const_cast<value_type &>(event.value);  // note! not const-safe
  log::info<5>("channel_reset_4={}, frame={}"sv, value, frame);
}

void MBPMarketRecovery::operator()(Trace<::cme::sbe::mdp::SecurityStatus30> const &event, protocol::mdp::Frame const &frame) {
  using value_type = std::remove_cvref_t<decltype(event)>::value_type;
  auto &value = const_cast<value_type &>(event.value);  // note! not const-safe
  log::info<5>("security_status_30={}, frame={}"sv, value, frame);
}

void MBPMarketRecovery::operator()(Trace<::cme::sbe::mdp::MDInstrumentDefinitionFuture54> const &event, protocol::mdp::Frame const &frame) {
  using value_type = std::remove_cvref_t<decltype(event)>::value_type;
  auto &value = const_cast<value_type &>(event.value);  // note! not const-safe
  log::info<5>("md_instrument_definition_future_54={}, frame={}"sv, value, frame);
}

void MBPMarketRecovery::operator()(Trace<::cme::sbe::mdp::MDInstrumentDefinitionOption55> const &event, protocol::mdp::Frame const &frame) {
  using value_type = std::remove_cvref_t<decltype(event)>::value_type;
  auto &value = const_cast<value_type &>(event.value);  // note! not const-safe
  log::info<5>("md_instrument_definition_option_55={}, frame={}"sv, value, frame);
}

void MBPMarketRecovery::operator()(Trace<::cme::sbe::mdp::MDInstrumentDefinitionSpread56> const &event, protocol::mdp::Frame const &frame) {
  using value_type = std::remove_cvref_t<decltype(event)>::value_type;
  auto &value = const_cast<value_type &>(event.value);  // note! not const-safe
  log::info<5>("md_instrument_definition_spread_56={}, frame={}"sv, value, frame);
}

void MBPMarketRecovery::operator()(Trace<::cme::sbe::mdp::MDInstrumentDefinitionFixedIncome57> const &event, protocol::mdp::Frame const &frame) {
  using value_type = std::remove_cvref_t<decltype(event)>::value_type;
  auto &value = const_cast<value_type &>(event.value);  // note! not const-safe
  log::info<5>("md_instrument_definition_fixed_income_57={}, frame={}"sv, value, frame);
}

void MBPMarketRecovery::operator()(Trace<::cme::sbe::mdp::MDInstrumentDefinitionRepo58> const &event, protocol::mdp::Frame const &frame) {
  using value_type = std::remove_cvref_t<decltype(event)>::value_type;
  auto &value = const_cast<value_type &>(event.value);  // note! not const-safe
  log::info<5>("md_instrument_definition_repo_58={}, frame={}"sv, value, frame);
}

void MBPMarketRecovery::operator()(Trace<::cme::sbe::mdp::MDInstrumentDefinitionFX63> const &event, protocol::mdp::Frame const &frame) {
  using value_type = std::remove_cvref_t<decltype(event)>::value_type;
  auto &value = const_cast<value_type &>(event.value);  // note! not const-safe
  log::info<5>("md_instrument_definition_fx_63={}, frame={}"sv, value, frame);
}

void MBPMarketRecovery::operator()(Trace<::cme::sbe::mdp::SnapshotFullRefresh52> const &event, protocol::mdp::Frame const &frame) {
  auto &[trace_info, snapshot_full_refresh_52] = event;
  using value_type = std::remove_cvref_t<decltype(event)>::value_type;
  auto &value = const_cast<value_type &>(snapshot_full_refresh_52);  // note! not const-safe
...
void MBPMarketRecovery::operator()(Trace<::cme::sbe::mdp::SnapshotFullRefreshLongQty69> const &event, protocol::mdp::Frame const &frame) {
  auto &[trace_info, snapshot_full_refresh_long_qty_69] = event;
  using value_type = std::remove_cvref_t<decltype(event)>::value_type;
  auto &value = const_cast<value_type &>(snapshot_full_refresh_long_qty_69);  // note! not const-safe
...
void MBPMarketRecovery::operator()(Trace<::cme::sbe::mdp::MDIncrementalRefreshBook46> const &event, protocol::mdp::Frame const &frame) {
  using value_type = std::remove_cvref_t<decltype(event)>::value_type;
  auto &value = const_cast<value_type &>(event.value);  // note! not const-safe
  log::info<5>("md_incremental_refresh_book_46={}, frame={}"sv, value, frame);
}

void MBPMarketRecovery::operator()(Trace<::cme::sbe::mdp::MDIncrementalRefreshBookLongQty64> const &event, protocol::mdp::Frame const &frame) {
  using value_type = std::remove_cvref_t<decltype(event)>::value_type;
  auto &value = const_cast<value_type &>(event.value);  // note! not const-safe
  log::info<5>("md_incremental_refresh_book_long_qty_64={}, frame={}"sv, value, frame);
}

void MBPMarketRecovery::operator()(Trace<::cme::sbe::mdp::SnapshotFullRefreshOrderBook53> const &event, protocol::mdp::Frame const &frame) {
  using value_type = std::remove_cvref_t<decltype(event)>::value_type;
  auto &value = const_cast<value_type &>(event.value);  // note! not const-safe
  log::info<5>("snapshot_full_refresh_order_book_53={}, frame={}"sv, value, frame);
}

void MBPMarketRecovery::operator()(Trace<::cme::sbe::mdp::MDIncrementalRefreshOrderBook47> const &event, protocol::mdp::Frame const &frame) {
  using value_type = std::remove_cvref_t<decltype(event)>::value_type;
  auto &value = const_cast<value_type &>(event.value);  // note! not const-safe
  log::info<5>("md_incremental_refresh_order_book_47={}, frame={}"sv, value, frame);
}

void MBPMarketRecovery::operator()(Trace<::cme::sbe::mdp::MDIncrementalRefreshTradeSummary48> const &event, protocol::mdp::Frame const &frame) {
  using value_type = std::remove_cvref_t<decltype(event)>::value_type;
  auto &value = const_cast<value_type &>(event.value);  // note! not const-safe
  log::info<5>("md_incremental_refresh_trade_summary_48={}, frame={}"sv, value, frame);
}

void MBPMarketRecovery::operator()(Trace<::cme::sbe::mdp::MDIncrementalRefreshTradeSummaryLongQty65> const &event, protocol::mdp::Frame const &frame) {
  using value_type = std::remove_cvref_t<decltype(event)>::value_type;
  auto &value = const_cast<value_type &>(event.value);  // note! not const-safe
  log::info<5>("md_incremental_refresh_trade_summary_long_qty_65={}, frame={}"sv, value, frame);
}

void MBPMarketRecovery::operator()(Trace<::cme::sbe::mdp::MDIncrementalRefreshDailyStatistics49> const &event, protocol::mdp::Frame const &frame) {
  using value_type = std::remove_cvref_t<decltype(event)>::value_type;
  auto &value = const_cast<value_type &>(event.value);  // note! not const-safe
  log::info<5>("md_incremental_refresh_daily_statistics_49={}, frame={}"sv, value, frame);
}

void MBPMarketRecovery::operator()(Trace<::cme::sbe::mdp::MDIncrementalRefreshSessionStatistics51> const &event, protocol::mdp::Frame const &frame) {
  using value_type = std::remove_cvref_t<decltype(event)>::value_type;
  auto &value = const_cast<value_type &>(event.value);  // note! not const-safe
  log::info<5>("md_incremental_refresh_session_statistics_51={}, frame={}"sv, value, frame);
}

void MBPMarketRecovery::operator()(Trace<::cme::sbe::mdp::MDIncrementalRefreshSessionStatisticsLongQty67> const &event, protocol::mdp::Frame const &frame) {
  using value_type = std::remove_cvref_t<decltype(event)>::value_type;
  auto &value = const_cast<value_type &>(event.value);  // note! not const-safe
  log::info<5>("md_incremental_refresh_session_statistics_long_qty_67={}, frame={}"sv, value, frame);
}

void MBPMarketRecovery::operator()(Trace<::cme::sbe::mdp::MDIncrementalRefreshVolume37> const &event, protocol::mdp::Frame const &frame) {
  using value_type = std::remove_cvref_t<decltype(event)>::value_type;
  auto &value = const_cast<value_type &>(event.value);  // note! not const-safe
  log::info<5>("md_incremental_refresh_volume_37={}, frame={}"sv, value, frame);
}

void MBPMarketRecovery::operator()(Trace<::cme::sbe::mdp::MDIncrementalRefreshVolumeLongQty66> const &event, protocol::mdp::Frame const &frame) {
  using value_type = std::remove_cvref_t<decltype(event)>::value_type;
  auto &value = const_cast<value_type &>(event.value);  // note! not const-safe
  log::info<5>("md_incremental_refresh_volume_long_qty_66={}, frame={}"sv, value, frame);
}

void MBPMarketRecovery::operator()(Trace<::cme::sbe::mdp::MDIncrementalRefreshLimitsBanding50> const &event, protocol::mdp::Frame const &frame) {
  using value_type = std::remove_cvref_t<decltype(event)>::value_type;
  auto &value = const_cast<value_type &>(event.value);  // note! not const-safe
  log::info<5>("md_incremental_refresh_limits_banding_50={}, frame={}"sv, value, frame);
}

void MBPMarketRecovery::operator()(Trace<::cme::sbe::mdp::QuoteRequest39> const &event, protocol::mdp::Frame const &frame) {
  using value_type = std::remove_cvref_t<decltype(event)>::value_type;
  auto &value = const_cast<value_type &>(event.value);  // note! not const-safe
